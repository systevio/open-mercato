...
The PR that carries this spec stays a draft until the ⚠ row is confirmed or changed.
...
- **Phase 5 - Lifecycle:** transaction events, subscriber, `sales.tax_transaction.record`, payload additions, undo void.
