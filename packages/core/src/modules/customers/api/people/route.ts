    ...
    afterList: async (payload, ctx) => {
      ...
      payload.items = items.map((item: unknown) => {
        ...
        return {
          ...
          is_tax_exempt: entity?.isTaxExempt ?? record.is_tax_exempt ?? false,
          tax_exemption_code: entity?.taxExemptionCode ?? record.tax_exemption_code ?? null,
          tax_exemption_certificate: entity?.taxExemptionCertificate ?? record.tax_exemption_certificate ?? null,
