...
export type { AddressLayoutDescriptor, DisplayAddressValue, AddressValidationIssue } from '@open-mercato/shared/lib/display/address'
...
export { getSubdivisions, isValidSubdivision, hasSubdivisions, ISO_SUBDIVISIONS } from '@open-mercato/shared/lib/location/subdivisions'
